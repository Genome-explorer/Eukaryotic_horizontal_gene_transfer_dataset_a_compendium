...
3. Combines them in order into a new FASTA file called CDS_gene.fasta
"""
...
def extract_and_combine_fasta(directory_path, output_file="CDS_gene.fasta"):
    """
...
def main():
    ...
    parser.add_argument(
        "-o", "--output", 
        default="CDS_gene.fasta",
        help="Name of output file (default: CDS_gene.fasta)"
    )
